    ...
    <div class="container-full">
            ...
            <div class="box-body" style="border: solid 1px; padding: 10px;">
                <div class="row"> <!-- 1st Row-->
                  ...
                  <div class="col-md-2 text-center" style="float: right">
                    <img src="{{url('upload/easyschool.png')}}" style="width: 140px; height: 100px;" alt="">
                  </div>
                  ...
                  <div class="col-md-4 text-center" style="float:left">
                    ...
                    <h6><strong>Severodonetsk</strong></h6>
                    <h5><strong><u><i>Academic Transcrpit</i></u></strong></h5>
      ...
      <div class="row"> <!-- 3td row start -->
        <div class="col-md-12">
          ...
          <tr>
            <td colspan="4"><strong style="padding-left: 30px;">Total Marks</strong></td>
            <td><strong style="padding-left: 38px;">{{ $total_marks }}</strong></td>
          </tr>
