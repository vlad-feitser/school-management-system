...
<table id="customers">
    <tr>
        ...
        <p><b>Student Monthly Fee</b></p></td>
    </tr>
    </table>

@php

    $monthlyfee = App\Models\FeeCategoryAmount::where('fee_category_id','3')->where('class_id',$details->class_id)->first();
...
<table id="customers">
  ...
  <tr>
    <td>8</td>
    <td><b>Fee for student of {{$month}}</b></td>
    <td>{{ $finalfee }}$</td>
  </tr>  
