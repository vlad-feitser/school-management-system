...
<table id="customers">
    <tr>
        ...
        <p><b>Student Exam Fee</b></p></td>
    </tr>
    </table>

@php

    $examfee = App\Models\FeeCategoryAmount::where('fee_category_id','2')->where('class_id',$details->class_id)->first();
...
<table id="customers">
  ...
  <tr>
    <td>8</td>
    <td><b>Fee for student of {{$exam_type}}</b></td>
    <td>{{ $finalfee }}$</td>
  </tr>  
