            ...
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2" style="padding-top:25px;">
                            <span class="btn btn-success addeventmore" style="margin-left: 10px"><i class="fa fa-plus-circle"></i></span>
                        </div> <!-- end col-md-2 -->
                    </div> <!-- End Row -->
        ...
        <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
            <div class="form-row">
                ...
                <div class="col-md-2" style="padding-top:25px;">
                    ...
                    <span class="btn btn-danger removeeventmore" style="margin-left: 6px"><i class="fa fa-minus-circle"></i></span>
                </div> <!-- end col-md-2 -->
