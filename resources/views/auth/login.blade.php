            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-6">
                        ...
                        <a href="{{ route('password.request') }}" class="text-black hover-warning"><i class="ion ion-locked"></i> Forgot pwd?</a><br>
                        </div>
                    </div>
                    <!-- /.col -->
                    ...
                    <!-- /.col -->
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Don't have an account? <a href=" {{ route('register') }} " class="text-black hover-warning ml-5">Sign Up</a></p>
							</div>
						</div>
					</div>
				</div>
